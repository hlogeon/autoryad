...
function copyrightMoguta(){
  $html = '';
  if (MG::getOption('copyrightMoguta')=='true') { 
...
function backgroundSite() {
  ...
  $backgr = (MG::getOption('BackgroundSite')!='')? SITE.MG::getOption('BackgroundSite'): '';
  if ($backgr) {
    $html = 'style="background: url('.SITE.(MG::getOption('backgroundSite')).') no-repeat fixed center center /100% auto #fff;" ';
  }
  echo $html;
}